...
(set-register ?f '(file . "/home/silas/Org/Family.s/Notes/hledger.org"))
(set-register ?r '(file . "/home/silas/README.org"))
(set-register ?d '(file . "/home/silas/.doom.d/doom.org"))
(set-register ?h '(file . "/home/silas"))
(set-register ?x '(file . "/home/silas/.xmonad/xmonad.org"))
(set-register ?s '(file . "/home/silas/.install/install.org"))
...
same directory as the org-buffer and insert a link to this file."
  ...
  (copy-file (concat "/home/silas/Templates/" template-file) filename)
...
(defun my-ox-odp ()
  ...
  (setq odp-style-file-name (completing-read "Choose style: "
                                             '("/home/silas/.doom.d/scripts/ox-odp/styles/water.odp"
                                                "/home/silas/.doom.d/scripts/ox-odp/styles/dark.odp"
                                              ) nil t))
...
(dolist (item full-org-roam-db-list)
  (setq full-org-roam-db-list-pretty
       (append (list
             (replace-regexp-in-string "\\/home\\/silas\\/Org\\/" "" item)) full-org-roam-db-list-pretty)))
...
(setq org-super-agenda-groups
       '(;; Each group has an implicit boolean OR operator between its selectors.
         (:name "Home Tech"
                :and(:file-path "silas/Agenda" :not (:tag "event"))
                :order 3)
...
(setq hledger-jfile "/home/silas/Org/Family.s/Notes/hledger.journal")
